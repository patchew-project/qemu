...
.. code-block:: shell
   ...
   TAG=$(curl -fsSL -o /dev/null -w '%{url_effective}' \
         https://github.com/rover2024/lorelei/releases/latest | sed 's|.*/tag/||')
   wget "https://github.com/rover2024/lorelei/releases/download/$TAG/lorelei-devkit-$ARCH-${TAG#v}.tar.xz"
