...
private:
    ...
    int64 extr_sil0il0bs3_il4il3bs1Tmsb3(uint64 instruction);
    ...
    int64 extr_sil16il0bs6Tmsb5(uint64 instruction);
    int64 extr_sil2il2bs6_il15il8bs1Tmsb8(uint64 instruction);
    int64 extr_sil3il3bs5_il15il8bs1Tmsb8(uint64 instruction);

    uint64 extr_acil14il0bs2Fmsb1(uint64 instruction);
    uint64 extr_bitil11il0bs6Fmsb5(uint64 instruction);
    uint64 extr_bitil21il0bs3Fmsb2(uint64 instruction);
    uint64 extr_c0sil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_codeil0il0bs18Fmsb17(uint64 instruction);
    uint64 extr_codeil0il0bs19Fmsb18(uint64 instruction);
    uint64 extr_codeil0il0bs2Fmsb1(uint64 instruction);
    uint64 extr_codeil0il0bs3Fmsb2(uint64 instruction);
    uint64 extr_codeil16il0bs10Fmsb9(uint64 instruction);
    uint64 extr_cofunil3il0bs23Fmsb22(uint64 instruction);
    uint64 extr_count3il12il0bs3Fmsb2(uint64 instruction);
    uint64 extr_countil0il0bs4Fmsb3(uint64 instruction);
    uint64 extr_countil16il0bs4Fmsb3(uint64 instruction);
    uint64 extr_csil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_csil21il0bs5Fmsb4(uint64 instruction);
    uint64 extr_ctil21il0bs5Fmsb4(uint64 instruction);
    uint64 extr_euil0il0bs4Fmsb3(uint64 instruction);
    uint64 extr_euil0il0bs7Fmsb6(uint64 instruction);
    uint64 extr_fdil11il0bs5Fmsb4(uint64 instruction);
    uint64 extr_fsil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_ftil11il0bs5Fmsb4(uint64 instruction);
    uint64 extr_ftil21il0bs5Fmsb4(uint64 instruction);
    uint64 extr_gpil2il0bs1Fmsb0(uint64 instruction);
    uint64 extr_hintil21il0bs5Fmsb4(uint64 instruction);
    uint64 extr_hsil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_lsbil0il0bs5Fmsb4(uint64 instruction);
    uint64 extr_maskil14il0bs7Fmsb6(uint64 instruction);
    uint64 extr_msbdil6il0bs5Fmsb4(uint64 instruction);
    uint64 extr_opil21il0bs5Fmsb4(uint64 instruction);
    uint64 extr_opil3il0bs23Fmsb22(uint64 instruction);
    uint64 extr_rd1il24il0bs1Fmsb0(uint64 instruction);
    uint64 extr_rd2il3il1bs1_il8il0bs1Fmsb1(uint64 instruction);
    uint64 extr_rd3il1il0bs3Fmsb2(uint64 instruction);
    uint64 extr_rdil11il0bs5Fmsb4(uint64 instruction);
    uint64 extr_rs3il4il0bs3Fmsb2(uint64 instruction);
    uint64 extr_rs4il0il0bs3_il4il3bs1Fmsb3(uint64 instruction);
    uint64 extr_rsil0il0bs5Fmsb4(uint64 instruction);
    uint64 extr_rsil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_rsz4il0il0bs3_il4il3bs1Fmsb3(uint64 instruction);
    uint64 extr_rt1il9il0bs1Fmsb0(uint64 instruction);
    uint64 extr_rt3il7il0bs3Fmsb2(uint64 instruction);
    uint64 extr_rt4il5il0bs3_il9il3bs1Fmsb3(uint64 instruction);
    uint64 extr_rtil21il0bs5Fmsb4(uint64 instruction);
    uint64 extr_rtil37il0bs5Fmsb4(uint64 instruction);
    uint64 extr_rtil5il0bs5Fmsb4(uint64 instruction);
    uint64 extr_rtz3il7il0bs3Fmsb2(uint64 instruction);
    uint64 extr_rtz4il21il0bs3_il25il3bs1Fmsb3(uint64 instruction);
    uint64 extr_rtz4il5il0bs3_il9il3bs1Fmsb3(uint64 instruction);
    uint64 extr_ruil3il0bs5Fmsb4(uint64 instruction);
    uint64 extr_sail11il0bs5Fmsb4(uint64 instruction);
    uint64 extr_sail12il0bs4Fmsb3(uint64 instruction);
    uint64 extr_sail13il0bs3Fmsb2(uint64 instruction);
    uint64 extr_selil11il0bs3Fmsb2(uint64 instruction);
    uint64 extr_selil11il0bs5Fmsb4(uint64 instruction);
    uint64 extr_shift3il0il0bs3Fmsb2(uint64 instruction);
    uint64 extr_shiftil0il0bs5Fmsb4(uint64 instruction);
    uint64 extr_shiftil0il0bs6Fmsb5(uint64 instruction);
    uint64 extr_shiftil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_shiftil6il0bs5Fmsb4(uint64 instruction);
    uint64 extr_shiftxil6il0bs6Fmsb5(uint64 instruction);
    uint64 extr_shiftxil7il1bs4Fmsb4(uint64 instruction);
    uint64 extr_sizeil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_stripeil6il0bs1Fmsb0(uint64 instruction);
    uint64 extr_stypeil16il0bs5Fmsb4(uint64 instruction);
    uint64 extr_u2il9il0bs2Fmsb1(uint64 instruction);
    uint64 extr_uil0il0bs12Fmsb11(uint64 instruction);
    uint64 extr_uil0il0bs16Fmsb15(uint64 instruction);
    uint64 extr_uil0il0bs18Fmsb17(uint64 instruction);
    uint64 extr_uil0il0bs2Fmsb1(uint64 instruction);
    ...
    uint64 extr_uil10il0bs1Fmsb0(uint64 instruction);
    uint64 extr_uil11il0bs7Fmsb6(uint64 instruction);
    uint64 extr_uil13il0bs8Fmsb7(uint64 instruction);
