...
FUNC_R_OP_R(conv_sf2uw_chop,    "%0 = convert_sf2uw(%2)")
FUNC_R_OP_R(conv_sf2w_chop,     "%0 = convert_sf2w(%2)")
FUNC_P_OP_R(conv_sf2ud_chop,    "%0 = convert_sf2ud(%2)")
FUNC_P_OP_R(conv_sf2d_chop,     "%0 = convert_sf2d(%2)")
...
FUNC_R_OP_P(conv_df2uw_chop,    "%0 = convert_df2uw(%2)")
FUNC_R_OP_P(conv_df2w_chop,     "%0 = convert_df2w(%2)")
FUNC_P_OP_P(conv_df2ud_chop,    "%0 = convert_df2ud(%2)")
FUNC_P_OP_P(conv_df2d_chop,     "%0 = convert_df2d(%2)")
