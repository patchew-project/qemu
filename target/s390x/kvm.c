...
static int kvm_clp_service_call(S390CPU *cpu, struct kvm_run *run)
{
    ...
    if (s390_has_feat(S390_FEAT_ZPCI)) {
        return clp_service_call(cpu, r2, 0);
    } else {
        return -1;
    }
}
...
static int kvm_pcilg_service_call(S390CPU *cpu, struct kvm_run *run)
{
    ...
    if (s390_has_feat(S390_FEAT_ZPCI)) {
        return pcilg_service_call(cpu, r1, r2, 0);
    } else {
        return -1;
    }
}
...
static int kvm_pcistg_service_call(S390CPU *cpu, struct kvm_run *run)
{
    ...
    if (s390_has_feat(S390_FEAT_ZPCI)) {
        return pcistg_service_call(cpu, r1, r2, 0);
    } else {
        return -1;
    }
}
...
static int kvm_stpcifc_service_call(S390CPU *cpu, struct kvm_run *run)
{
    ...
    if (s390_has_feat(S390_FEAT_ZPCI)) {
        ...
        return stpcifc_service_call(cpu, r1, fiba, ar, 0);
    } else {
        return -1;
    }
}
...
static int kvm_rpcit_service_call(S390CPU *cpu, struct kvm_run *run)
{
    ...
    if (s390_has_feat(S390_FEAT_ZPCI)) {
        return rpcit_service_call(cpu, r1, r2, 0);
    } else {
        return -1;
    }
}
...
static int kvm_pcistb_service_call(S390CPU *cpu, struct kvm_run *run)
{
    ...
    if (s390_has_feat(S390_FEAT_ZPCI)) {
        ...
        return pcistb_service_call(cpu, r1, r3, gaddr, ar, 0);
    } else {
        return -1;
    }
}
...
static int kvm_mpcifc_service_call(S390CPU *cpu, struct kvm_run *run)
{
    ...
    if (s390_has_feat(S390_FEAT_ZPCI)) {
        ...
        return mpcifc_service_call(cpu, r1, fiba, ar, 0);
    } else {
        return -1;
    }
}
