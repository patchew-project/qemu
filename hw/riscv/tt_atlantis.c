...
static void finalize_fdt(TTAtlantisState *s)
{
    ...
    g_autofree char *hsio_name = create_fdt_prcm(fdt,
        &s->memmap[TT_ATL_PRCM_HSIO], "hsio");
    ...
    g_autofree char *pcie_name = create_fdt_prcm(fdt,
        &s->memmap[TT_ATL_PRCM_PCIE], "pcie");
