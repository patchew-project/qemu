/*
 * QEMU sPAPR EEH (Enhanced Error Handling) support
 *
 ...
 * Compiled only when CONFIG_VFIO_PCI is enabled (build system guard).
 * No #include CONFIG_DEVICES is required here.
 */
