                                             ...
                                             size_t *len_out)
{
    ...
    /*
     * Per Table 8-331, the returned list excludes Discovery (entry 0).
     */
    int total = ARRAY_SIZE(media_op_matrix) - 1;
    ...
    for (i = 0; i < num_ops; i++) {
        int idx = start_index + i + 1; /* +1 skips Discovery at entry 0 */
